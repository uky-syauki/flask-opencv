...
Revision ID: b9971ea3355f
Revises: 723ff20443ed
Create Date: 2023-09-10 01:31:51.923135
...
revision = 'b9971ea3355f'
down_revision = '723ff20443ed'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('sdata', sa.TEXT(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    with op.batch_alter_table('admin', schema=None) as batch_op:
